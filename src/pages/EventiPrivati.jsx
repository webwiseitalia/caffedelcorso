          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                <span className="text-title">Chiamaci: 0364 194 5781</span>
              </a>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 px-8 py-4 border transition-all duration-300 hover:bg-[var(--color-text)] hover:text-[var(--color-bg)]"
                style={{
